...
const Map<String, List<String>> kTurkeyCities = {
  ...
  'Adıyaman': ['Adıyaman', 'Besni', 'Gerger', 'Gölbaşı', 'Kahta', 'Samsat', 'Sincik', 'Tut', 'Çelikhan'],
  'Afyonkarahisar': ['Afyon', 'Bayat', 'Başmakçı', 'Bolvadin', 'Dazkırı', 'Dinar', 'Emirdağ', 'Evciler', 'Hocalar', 'Kızılören', 'Sandıklı', 'Sincanlı', 'Sultandağı', 'Çay', 'Çobanlar', 'İhsaniye', 'İscehisar', 'Şuhut'],
  ...
  'Ankara': ['Akyurt', 'Altındağ', 'Ayaş', 'Bala', 'Beypazarı', 'Elmadağ', 'Etimesgut', 'Evren', 'Gölbaşı', 'Güdül', 'Haymana', 'Kalecik', 'Kazan', 'Keçiören', 'Kızılcahamam', 'Mamak', 'Nallıhan', 'Polatlı', 'Pursaklar', 'Sincan', 'Yenimahalle', 'Çamlıdere', 'Çankaya', 'Çubuk', 'Şereflikoçhisar'],
  ...
  'Artvin': ['Ardanuç', 'Arhavi', 'Artvin', 'Borçka', 'Hopa', 'Murgul', 'Yusufeli', 'Şavşat'],
  'Aydın': ['Aydın', 'Bozdoğan', 'Buharkent', 'Didim', 'Germencik', 'Karacasu', 'Karpuzlu', 'Koçarlı', 'Kuyucak', 'Kuşadası', 'Köşk', 'Nazilli', 'Sultanhisar', 'Söke', 'Yenipazar', 'Çine', 'İncirliova'],
  'Balıkesir': ['Ayvalık', 'Balya', 'Balıkesir', 'Bandırma', 'Bigadiç', 'Burhaniye', 'Dursunbey', 'Edremit', 'Erdek', 'Gömeç', 'Gönen', 'Havran', 'Kepsut', 'Manyas', 'Marmara', 'Savaştepe', 'Susurluk', 'Sındırgı', 'İvrindi'],
  'Bilecik': ['Bilecik', 'Bozüyük', 'Gölpazarı', 'Osmaneli', 'Pazaryeri', 'Söğüt', 'Yenipazar', 'İnhisar'],
  ...
  'Burdur': ['Altınyayla', 'Ağlasun', 'Bucak', 'Burdur', 'Gölhisar', 'Karamanlı', 'Kemer', 'Tefenni', 'Yeşilova', 'Çavdır', 'Çeltikçi'],
  ...
  'Çanakkale': ['Ayvacık', 'Bayramiç', 'Biga', 'Bozcaada', 'Eceabat', 'Ezine', 'Gelibolu', 'Gökçeada', 'Lapseki', 'Yenice', 'Çan', 'Çanakkale'],
  'Çankırı': ['Atkaracalar', 'Bayramören', 'Eldivan', 'Ilgaz', 'Korgun', 'Kurşunlu', 'Kızılırmak', 'Orta', 'Yapraklı', 'Çankırı', 'Çerkeş', 'Şabanözü'],
  'Çorum': ['Alaca', 'Bayat', 'Boğazkale', 'Dodurga', 'Kargı', 'Laçin', 'Mecitözü', 'Ortaköy', 'Osmancık', 'Oğuzlar', 'Sungurlu', 'Uğurludağ', 'Çorum', 'İskilip'],
  'Denizli': ['Acıpayam', 'Akköy', 'Babadağ', 'Baklan', 'Bekilli', 'Beyağaç', 'Bozkurt', 'Buldan', 'Denizli', 'Güney', 'Honaz', 'Kale', 'Sarayköy', 'Serinhisar', 'Tavas', 'Çal', 'Çameli', 'Çardak', 'Çivril'],
  ...
  'Edirne': ['Edirne', 'Enez', 'Havsa', 'Keşan', 'Lalapaşa', 'Meriç', 'Süloğlu', 'Uzunköprü', 'İpsala'],
  'Elazığ': ['Alacakaya', 'Arıcak', 'Ağın', 'Baskil', 'Elazığ', 'Karakoçan', 'Keban', 'Kovancılar', 'Maden', 'Palu', 'Sivrice'],
  'Erzincan': ['Erzincan', 'Ilıç', 'Kemah', 'Kemaliye', 'Otlukbeli', 'Refahiye', 'Tercan', 'Çayırlı', 'Üzümlü'],
  ...
  'Giresun': ['Alucra', 'Bulancak', 'Dereli', 'Doğankent', 'Espiye', 'Eynesil', 'Giresun', 'Görele', 'Güce', 'Keşap', 'Piraziz', 'Tirebolu', 'Yağlıdere', 'Çamoluk', 'Çanakçı', 'Şebinkarisar'],
  'Gümüşhane': ['Gümüşhane', 'Kelkit', 'Köse', 'Kürtün', 'Torul', 'Şiran'],
  'Hakkari': ['Hakkari', 'Yüksekova', 'Çukurca', 'Şemdinli'],
  'Hatay': ['Altınözü', 'Antakya', 'Belen', 'Dörtyol', 'Erzin', 'Hassa', 'Kumlu', 'Kırıkhan', 'Reyhanlı', 'Samandağ', 'Yayladağı', 'İskenderun'],
  'Isparta': ['Aksu', 'Atabey', 'Eğirdir', 'Gelendost', 'Gönen', 'Isparta', 'Keçiborlu', 'Senirkent', 'Sütçüler', 'Uluborlu', 'Yalvaç', 'Yenişarbademli', 'Şarkikaraağaç'],
  ...
  'Kars': ['Akyaka', 'Arpaçay', 'Digor', 'Kars', 'Kağızman', 'Sarıkamış', 'Selim', 'Susuz'],
  'Kastamonu': ['Abana', 'Araç', 'Azdavay', 'Ağlı', 'Bozkurt', 'Cide', 'Daday', 'Devrekani', 'Doğanyurt', 'Hanönü', 'Kastamonu', 'Küre', 'Pınarbaşı', 'Seydiler', 'Taşköprü', 'Tosya', 'Çatalzeytin', 'İhsangazi', 'İnebolu', 'Şenpazar'],
  ...
  'Kırklareli': ['Babaeski', 'Demirköy', 'Kofçaz', 'Kırklareli', 'Lüleburgaz', 'Pehlivanköy', 'Pınarhisar', 'Vize'],
  'Kırşehir': ['Akpınar', 'Akçakent', 'Boztepe', 'Kaman', 'Kırşehir', 'Mucur', 'Çiçekdağı'],
  ...
  'Kütahya': ['Altıntaş', 'Aslanapa', 'Domaniç', 'Dumlupınar', 'Emet', 'Gediz', 'Hisarcık', 'Kütahya', 'Pazarlar', 'Simav', 'Tavşanlı', 'Çavdarhisar', 'Şaphane'],
  'Malatya': ['Akçadağ', 'Arapkir', 'Arguvan', 'Battalgazi', 'Darende', 'Doğanyol', 'Doğanşehir', 'Hekimhan', 'Kale', 'Kuluncak', 'Malatya', 'Pütürge', 'Yazıhan', 'Yeşilyurt'],
  'Manisa': ['Ahmetli', 'Akhisar', 'Alaşehir', 'Demirci', 'Gölmarmara', 'Gördes', 'Kula', 'Köprübaşı', 'Kırkağaç', 'Manisa', 'Salihli', 'Saruhanlı', 'Sarıgöl', 'Selendi', 'Soma', 'Turgutlu'],
  'Kahramanmaraş': ['Afşin', 'Andırın', 'Ekinözü', 'Elbistan', 'Göksun', 'Kahramanmaraş', 'Nurhak', 'Pazarcık', 'Türkoğlu', 'Çağlıyancerit'],
  'Mardin': ['Dargeçit', 'Derik', 'Kızıltepe', 'Mardin', 'Mazıdağı', 'Midyat', 'Nusaybin', 'Savur', 'Yeşilli', 'Ömerli'],
  ...
  'Niğde': ['Altunhisar', 'Bor', 'Niğde', 'Ulukışla', 'Çamardı', 'Çiftlik'],
  'Ordu': ['Akkuş', 'Aybastı', 'Fatsa', 'Gölköy', 'Gülyalı', 'Gürgentepe', 'Kabadüz', 'Kabataş', 'Korgan', 'Kumru', 'Mesudiye', 'Ordu', 'Perşembe', 'Ulubey', 'Çamaş', 'Çatalpınar', 'Çaybaşı', 'Ünye', 'İkizce'],
  'Rize': ['Ardeşen', 'Derepazarı', 'Fındıklı', 'Güneysu', 'Hemşin', 'Kalkandere', 'Pazar', 'Rize', 'Çamlıhemşin', 'Çayeli', 'İkizdere', 'İyidere'],
  'Sakarya': ['Adapazarı', 'Akyazı', 'Arifiye', 'Erenler', 'Ferizli', 'Geyve', 'Hendek', 'Karapürçek', 'Karasu', 'Kaynarca', 'Kocaali', 'Pamukova', 'Sapanca', 'Serdivan', 'Söğütlü', 'Taraklı'],
  'Samsun': ['Alaçam', 'Asarcık', 'Atakum', 'Ayvacık', 'Bafra', 'Canik', 'Havza', 'Kavak', 'Ladik', 'Ondokuzmayıs', 'Salıpazarı', 'Tekkeköy', 'Terme', 'Vezirköprü', 'Yakakent', 'Çarşamba', 'İlkadım'],
  ...
  'Sivas': ['Akıncılar', 'Altınyayla', 'Divriği', 'Doğanşar', 'Gemerek', 'Gölova', 'Gürün', 'Hafik', 'Kangal', 'Koyulhisar', 'Sivas', 'Suşehri', 'Ulaş', 'Yıldızeli', 'Zara', 'İmranlı', 'Şarkışla'],
  'Tekirdağ': ['Hayrabolu', 'Malkara', 'Marmaraereğlisi', 'Muratlı', 'Saray', 'Tekirdağ', 'Çerkezköy', 'Çorlu', 'Şarköy'],
  'Tokat': ['Almus', 'Artova', 'Başçiftlik', 'Erbaa', 'Niksar', 'Pazar', 'Reşadiye', 'Sulusaray', 'Tokat', 'Turhal', 'Yeşilyurt', 'Zile'],
  'Trabzon': ['Akçaabat', 'Araklı', 'Arsin', 'Beşikdüzü', 'Dernekpazarı', 'Düzköy', 'Hayrat', 'Köprübaşı', 'Maçka', 'Of', 'Sürmene', 'Tonya', 'Trabzon', 'Vakfıkebir', 'Yomra', 'Çarşıbaşı', 'Çaykara', 'Şalpazarı'],
  'Tunceli': ['Hozat', 'Mazgirt', 'Nazımiye', 'Ovacık', 'Pertek', 'Pülümür', 'Tunceli', 'Çemişgezek'],
  'Şanlıurfa': ['Akçakale', 'Birecik', 'Bozova', 'Ceylanpınar', 'Halfeti', 'Harran', 'Hilvan', 'Siverek', 'Suruç', 'Viranşehir', 'Şanlıurfa'],
  'Uşak': ['Banaz', 'Eşme', 'Karahallı', 'Sivaslı', 'Ulubey', 'Uşak'],
  'Van': ['Bahçesaray', 'Başkale', 'Edremit', 'Erciş', 'Gevaş', 'Gürpınar', 'Muradiye', 'Saray', 'Van', 'Çaldıran', 'Çatak', 'Özalp'],
  'Yozgat': ['Akdağmadeni', 'Aydıncık', 'Boğazlıyan', 'Kadışehri', 'Saraykent', 'Sarıkaya', 'Sorgun', 'Yenifakılı', 'Yerköy', 'Yozgat', 'Çandır', 'Çayıralan', 'Çekerek', 'Şefaatli'],
  'Zonguldak': ['Alaplı', 'Devrek', 'Gökçebey', 'Karadenizereğli', 'Zonguldak', 'Çaycuma'],
  'Aksaray': ['Aksaray', 'Ağaçören', 'Eskil', 'Gülağaç', 'Güzelyurt', 'Ortaköy', 'Sarıyahşi'],
  'Bayburt': ['Aydıntepe', 'Bayburt', 'Demirözü'],
  'Karaman': ['Ayrancı', 'Başyayla', 'Ermenek', 'Karaman', 'Kazımkarabekir', 'Sarıveliler'],
  'Kırıkkale': ['Bahşili', 'Balışeyh', 'Delice', 'Karakeçili', 'Keskin', 'Kırıkkale', 'Sulakyurt', 'Yahşihan', 'Çelebi'],
  'Batman': ['Batman', 'Beşiri', 'Gercüş', 'Hasankeyf', 'Kozluk', 'Sason'],
  'Şırnak': ['Beytüşşebap', 'Cizre', 'Güçlükonak', 'Silopi', 'Uludere', 'İdil', 'Şırnak'],
  'Bartın': ['Amasra', 'Bartın', 'Kurucaşile', 'Ulus'],
  'Ardahan': ['Ardahan', 'Damal', 'Göle', 'Hanak', 'Posof', 'Çıldır'],
  'Iğdır': ['Aralık', 'Iğdır', 'Karakoyunlu', 'Tuzluca'],
  'Yalova': ['Altınova', 'Armutlu', 'Termal', 'Yalova', 'Çiftlikköy', 'Çınarcık'],
  ...
  'Düzce': ['Akçakoca', 'Cumayeri', 'Düzce', 'Gölyaka', 'Gümüşova', 'Kaynaşlı', 'Yığılca', 'Çilimli'],
};
...
class AppProvider with ChangeNotifier {
  ...
  final List<JobPosting> _defaultJobPostings = [
    ...
    JobPosting(
      id: 'ilan2',
      companyId: 'restoran1',
      companyName: 'Lezzet Restoranı',
      title: 'Kadıköy Şubemize A2 Ehliyetli Kurye',
      description: 'Kadıköy şubemizde çalışmak üzere A2 ehliyeti olan, restoran kuryesi arıyoruz. Yemek + SGK + Prim.',
      city: 'İstanbul',
      district: 'Kadıköy',
      salary: 'Aylık 35.000 TL + Prim',
      createdAt: DateTime.now().subtract(const Duration(days: 1)).toIso8601String(),
    ),
    JobPosting(
      id: 'ilan3',
      companyId: 'firma2',
      companyName: 'Ege Lojistik',
      title: 'Bornova Bölgesi Esnaf Kuryeler',
      description: 'Bornova ve çevresinde kendi motoruyla paket teslimatı yapacak esnaf kurye iş ortakları arıyoruz.',
      city: 'İzmir',
      district: 'Bornova',
      salary: 'Paket Başı 45 TL',
