...
class _MarketingViewState extends State<MarketingView> {
  ...
  final _faqData = const [
    {
      'q': 'Sistem hangi pazaryerleri ile entegre çalışmaktadır?',
      'a': 'KuryeApp; popüler online yemek siparişi ve market platformlarıyla doğrudan API entegrasyonuna sahiptir. Gelen tüm siparişler tek havuzda toplanır.'
    },
    {
      'q': 'Kuryelerin takibini nasıl sağlıyoruz?',
      'a': 'Kuryelerimizin kullandığı mobil uygulama üzerinden alınan anlık GPS verileri sayesinde, tüm kuryelerin konumlarını, hızlarını ve teslimat süreçlerini yönetici haritası üzerinden canlı olarak izleyebilirsiniz.'
    ...
    {
      'q': 'Otomatik atama algoritması nasıl çalışır?',
      'a': 'Geliştirdiğimiz yapay zeka algoritması; siparişi hazırlayan restoranın konumu ile aktif durumdaki kuryelerin mesafelerini, kuryelerin üzerindeki aktif iş yüklerini ve geçmiş performans puanlarını anlık analiz ederek paketi en uygun kuryeye 60 saniye içinde otomatik atar.'
    },
    {
      'q': 'Kurye performansı nasıl ölçülüyor?',
      ...
      slivers: [
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: const Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 6),
                            Text('%100 Bulut Tabanlı & Otomatik', style: TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ),
                      ...
                      const Text(
                        'Sıfır hata ile teslimat operasyonunuzu yönetin.',
                        style: TextStyle(color: Colors.white70, fontSize: 14, fontWeight: FontWeight.w500),
                      ),
                      const SizedBox(height: 20),
                      ElevatedButton.icon(
                        onPressed: () => _showDemoSelection(context, provider),
                        icon: const Icon(LucideIcons.playCircle, size: 18),
                        label: const Text('Panel Demosu', style: TextStyle(fontWeight: FontWeight.bold)),
        ...
        SliverList(
          delegate: SliverChildListDelegate([
            ...
            _buildSectionTitle('Özellikler', 'Hızlı ve Hatasız Operasyon'),
            _buildQuickFeatures(),
            const SizedBox(height: 32),
            _buildSectionTitle('Fiyatlandırma', 'Bütçenize Uygun'),
            _buildPricingCard(),
            const SizedBox(height: 32),
            _buildSectionTitle('S.S.S.', 'Sıkça Sorulan Sorular'),
            _buildFaqSection(),
            const SizedBox(height: 32),
            _buildSectionTitle('İletişim', 'Bize Ulaşın'),
  ...
  Widget _buildDesktopLayout(AppProvider provider, double w, bool isDesktop, bool isMd) {
    return Scaffold(
              ...
              children: [
                Expanded(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      // Logo & Top Nav placeholder
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          const Text('KuryeApp', style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.w900, letterSpacing: -1)),
                          ElevatedButton.icon(
                            onPressed: widget.onPanelClick,
                            icon: const Icon(LucideIcons.building2, size: 16),
                            label: const Text('Yönetim Paneline Giriş Yap', style: TextStyle(fontWeight: FontWeight.bold)),
                            style: ElevatedButton.styleFrom(
                      ...
                      Container(
                        ...
                        child: const Row(
                          ...
                          children: [
                            Icon(LucideIcons.sparkles, color: Colors.white, size: 14),
                            SizedBox(width: 6),
                            Text('%100 Bulut Tabanlı & Otomatik', style: TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ),
                      const SizedBox(height: 24),
                      const Text('Akıllı Kurye Takip\nve Teslimat', style: TextStyle(color: Colors.white, fontSize: 56, fontWeight: FontWeight.w900, height: 1.1, letterSpacing: -2)),
                      const SizedBox(height: 16),
                      const Text('Sıfır hata ile teslimat operasyonunuzu yönetin.', style: TextStyle(color: Colors.white70, fontSize: 18, fontWeight: FontWeight.w500)),
                      ...
                      Row(
                        children: [
                          ElevatedButton.icon(
                            ...
                            label: const Text('Canlı Panel Demosu', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                            style: ElevatedButton.styleFrom(backgroundColor: _kWhite, foregroundColor: _kIndigo, padding: const EdgeInsets.symmetric(horizontal: 28, vertical: 18), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14))),
                          ),
                        ]
                      ),
                      const SizedBox(height: 40),
                      Row(
                        children: [
                          _statItem('2000+', 'Aktif Şube', false, isDesktop: true),
                          const SizedBox(width: 32),
                          _statItem('100K+', 'Günlük Paket', false, isDesktop: true),
                          const SizedBox(width: 32),
                          _statItem('%99.4', 'Başarılı ETA', true, isDesktop: true),
                        ],
                      )
                    ],
                  ),
  ...
  Widget build(BuildContext context) {
    ...
    if (!isDesktop) {
      ...
      return _buildDesktopLayout(provider, w, isDesktop, isMd);
    }
  }
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Text(badge, style: const TextStyle(color: _kIndigo, fontSize: 10, fontWeight: FontWeight.w900)),
          ),
          const SizedBox(height: 8),
          Text(title, style: const TextStyle(color: _kTextHead, fontSize: 24, fontWeight: FontWeight.w900, letterSpacing: -0.5)),
          const SizedBox(height: 16),
        ],
      ),
    );
  ...
  Widget _buildStatsRow() {
    return Padding(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          _statItem('2000+', 'Aktif Şube', false),
          _statItem('100K+', 'Günlük Paket', false),
          _statItem('%99.4', 'Başarılı ETA', true),
        ],
      ),
    );
  }

  Widget _statItem(String val, String label, bool highlight, {bool isDesktop = false}) {
    return Column(
      crossAxisAlignment: isDesktop ? CrossAxisAlignment.start : CrossAxisAlignment.center,
      children: [
        Text(val, style: TextStyle(color: highlight ? _kIndigo : (isDesktop ? Colors.white : _kTextHead), fontSize: isDesktop ? 28 : 20, fontWeight: FontWeight.w900)),
        const SizedBox(height: 4),
        Text(label, style: TextStyle(color: isDesktop ? Colors.white70 : _kTextMuted, fontSize: isDesktop ? 12 : 10, fontWeight: FontWeight.bold)),
      ],
    );
  }

  Widget _buildSimulatorCard() {
    return const InteractiveSimulatorCard();
  }
  ...
  Widget _buildQuickFeatures() {
    return Padding(
      ...
      child: Column(
        children: [
          _featureCard(LucideIcons.refreshCw, '%100 Otomatik Kurye Atama', 'Yapay zeka algoritması ile paketi kuryeye 60 saniyede atar.'),
          const SizedBox(height: 12),
          _featureCard(LucideIcons.mapPin, 'Canlı Harita ve Takip', 'GPS koordinatları ile kuryeleri haritadan izleyin.'),
          const SizedBox(height: 12),
          _featureCard(LucideIcons.building2, 'Tüm Entegrasyonlar', 'Popüler online yemek sipariş platformlarıyla entegre çalışır.'),
        ],
      ),
    );
  }
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(icon, color: _kIndigo, size: 24),
          ),
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(title, style: const TextStyle(color: _kTextHead, fontSize: 14, fontWeight: FontWeight.bold)),
                const SizedBox(height: 4),
                Text(desc, style: const TextStyle(color: _kTextBody, fontSize: 12)),
              ],
            ),
          ),
        ],
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: _kIndigo.withValues(alpha: 0.1), blurRadius: 20, offset: const Offset(0, 8))],
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text('Hepsi Bir Arada Plan', style: TextStyle(color: _kIndigo, fontSize: 12, fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
            const Row(
              crossAxisAlignment: CrossAxisAlignment.baseline,
              textBaseline: TextBaseline.alphabetic,
              children: [
                Text('2.5 TL', style: TextStyle(color: _kTextHead, fontSize: 32, fontWeight: FontWeight.w900)),
                SizedBox(width: 4),
                Text('/ paket başı', style: TextStyle(color: _kTextMuted, fontSize: 14)),
              ],
            ),
            const SizedBox(height: 12),
            const Text('Aylık sabit ücret yok. Sadece kullandığınız kadar ödeyin.', style: TextStyle(color: _kTextBody, fontSize: 13)),
            const Divider(height: 32, color: _kBorderLight),
            ...[
              'Otomatik Kurye Atama',
              'Canlı Harita Takibi',
              'Tüm API Entegrasyonları',
              'Sınırsız Şube Ekleme'
            ].map((f) => Padding(
              padding: const EdgeInsets.only(bottom: 12),
              child: Row(
                children: [
                  const Icon(LucideIcons.checkCircle2, color: _kGreen, size: 18),
                  const SizedBox(width: 12),
                  Text(f, style: const TextStyle(color: _kTextHead, fontSize: 13, fontWeight: FontWeight.w600)),
                ],
              ),
            )),
          ],
        ...
        children: _faqData.map((faq) {
          return Container(
            ...
            child: Theme(
              ...
              child: ExpansionTile(
                title: Text(faq['q']!, style: const TextStyle(color: _kTextHead, fontSize: 13, fontWeight: FontWeight.bold)),
                iconColor: _kIndigo,
                collapsedIconColor: _kTextMuted,
                children: [
                  Padding(
                    padding: const EdgeInsets.fromLTRB(16, 0, 16, 16),
                    child: Text(faq['a']!, style: const TextStyle(color: _kTextBody, fontSize: 12, height: 1.5)),
                  ),
                ],
              ),
            ),
  ...
  Widget _buildContactForm(AppProvider provider) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 20.0),
      child: Container(
        ...
        child: Form(
          ...
          child: Column(
            children: [
              _mobileFormField('Adınız Soyadınız', _nameController),
              const SizedBox(height: 12),
              _mobileFormField('Telefon Numarası', _phoneController, type: TextInputType.phone),
              const SizedBox(height: 12),
              _mobileFormField('Mesajınız', _messageController, multiline: true),
              const SizedBox(height: 20),
              SizedBox(
                width: double.infinity,
                child: ElevatedButton(
                  onPressed: _isSubmitted ? null : () => _handleSubmit(provider),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: _kIndigo,
                    padding: const EdgeInsets.symmetric(vertical: 14),
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                  ),
                  child: Text(_isSubmitted ? 'Gönderiliyor...' : 'Talep Gönder', style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 14)),
                ),
              ),
            ],
          ),
  ...
  Widget _mobileFormField(String label, TextEditingController ctrl, {bool multiline = false, TextInputType type = TextInputType.text}) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: _kIndigo, width: 1.5)),
      ),
    );
  }

  void _showDemoSelection(BuildContext context, AppProvider provider) {
      ...
      builder: (ctx) => Container(
        ...
        child: SafeArea(
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text('Panel Demosu', style: TextStyle(color: _kTextHead, fontSize: 20, fontWeight: FontWeight.w900, letterSpacing: -0.5)),
              const SizedBox(height: 8),
              const Text('Hangi paneli demo kullanıcısı olarak test etmek istersiniz? Çıkış yaptığınızda verileriniz kaydedilmez.',
                style: TextStyle(color: _kTextBody, fontSize: 12)),
              const SizedBox(height: 24),
              _demoOption(ctx, provider, 'Restoran Paneli', 'restoran', LucideIcons.chefHat, _kOrange),
              const SizedBox(height: 12),
              _demoOption(ctx, provider, 'Kurye Firması Paneli', 'firma', LucideIcons.building2, _kPurple),
              const SizedBox(height: 12),
              _demoOption(ctx, provider, 'Kurye Uygulaması', 'kurye', LucideIcons.bike, _kIndigo),
  ...
  Widget _demoOption(BuildContext ctx, AppProvider provider, String title, String role, IconData icon, Color color) {
    return GestureDetector(
      onTap: () {
        Navigator.pop(ctx);
        provider.loginAsDemo(role);
      },
      child: Container(
        padding: const EdgeInsets.all(16),
        decoration: BoxDecoration(
        ...
        child: Row(
          children: [
            ...
            const SizedBox(width: 16),
            Expanded(
              child: Text(title, style: const TextStyle(color: _kTextHead, fontSize: 14, fontWeight: FontWeight.bold)),
            ),
            const Icon(LucideIcons.chevronRight, color: _kTextMuted, size: 20),
          ],
        ),
      ),
    );
        ...
        child: Stack(
          ...
          children: [
            ...
            AnimatedPositioned(
              ...
              top: _step >= 4 ? -40 : -120, // Drop from above the card
                      ...
                      const Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 4),
                            Text('Siparişiniz yola çıktı! Canlı takip için: kurye.app/os-8742', style: TextStyle(color: _kTextBody, fontSize: 10, height: 1.3)),
                          ],
                        ),
                      )
                    ],
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(_step == 3 ? 'Paketi Almaya Gidiyor' : 'Teslimata Çıktı', style: const TextStyle(color: _kTextBody, fontSize: 11)),
                    ]
                  )
                ),
